...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if (
        ...
        // Ajoutez la réponse en utilisant la méthode du contrôleur
    ...
    // Vous pouvez également rediriger l'utilisateur vers une page d'erreur ou vers la liste des réclamations.
    exit();
}
...
<a class="btn btn-success btn-sm" href="https://startbootstrap.com/theme/sb-admin-pro">Upgrade to Pro!</a>
    ...
    <a href="http://localhost/artisanicaReclam/view/BackOffice/tablesReclam.php">Retour à la liste des reponses</a>
    <hr>
