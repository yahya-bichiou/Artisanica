    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <h2 class="text-center">Modifier Don</h2>
    <form class="text-left clearfix" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <div class="form-group">
            
            <input class="form-control"  placeholder="Nom d'Event" type="text" id="typedon" name="typedon" value="<?php echo $donDetails['typedon']; ?>" />
                    <span id="erreurNom" style="color: red"></span>
             
            </div>
            <div class="form-group">
            <input class="form-control" placeholder="Localisation" type="text" id="montant" name="montant" value="<?php echo $donDetails['montant']; ?>" />
