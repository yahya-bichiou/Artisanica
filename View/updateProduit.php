            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="backoffice/blank.html">Blank Page</a>
                    </div>
                </div>
            </li>
...
<body>
    ...
    ?>
        ...
        <form action="" method="POST">
            <table>
            <tr>
                    <td><label for="id_produit">Id Produit :</label></td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span id="erreurPrixProduit" style="color: red"></span>
                    </td>
                </tr>
                <tr>
                    <td><label for="nb_stock">Nombre De Stock :</label></td>
                    <td>
                        <input type="text" id="nb_stock" name="nb_stock" value="<?php echo $produit['nb_stock'] ?>" />
                        <span id="erreurnb_stock" style="color: red"></span>
                    </td>
                </tr>
                <tr>
                    <td><label for="nb_stock">Nom Image :</label></td>
                    <td>
                        <input type="text" id="nom_image" name="nom_image" value="<?php echo $produit['nom_image'] ?>" />
                        <span id="erreurImage" style="color: red"></span>
                    </td>
                </tr>
                <tr>
                    <td><label for="nb_stock">id categorie :</label></td>
                    <td>
                        <input type="text" id="id_categorieP" name="id_categorieP" value="<?php echo $produit['id_categorieP'] ?>" />
                        <span id="erreurImage" style="color: red"></span>
                    </td>
                </tr>
                <td>
