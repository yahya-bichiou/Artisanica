...
$pdo = new PDO('mysql:host=localhost;dbname=artisanica', 'root', '');
$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$id= $_GET['id_categorie'];
$sql=$pdo->prepare(query: "SELECT * FROM categorie WHERE id_categorie=?");
$sql->execute([$id]);
$all_categorie=$sql->fetch(mode: PDO::FETCH_ASSOC);

$sql=$pdo->prepare(query: "SELECT * FROM produit WHERE id_categorieP=?");
$sql->execute([$id]);
$produits = $sql->fetchAll(mode: PDO::FETCH_OBJ);
...
<section class="menu">
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 mb-sm-3">
									<ul>
										...
										<li role="separator" class="divider"></li>
										<li><a href="product-single.html">Produit Details</a></li>
   ...
   <h2><?php echo $all_categorie['nom_categorie']?></h2>
    <div class="pro-container">
	<?php
        foreach ($produits as $produit){
	?>
            <div class="pro">
                <img src="images/shop/products/<?= $produit->nom_image ?>" alt="">
                <div class="des">
