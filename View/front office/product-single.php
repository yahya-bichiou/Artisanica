...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>Artisanica | products</title>
...
<section class="page-header">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">Recherche Produits</h1>
					<ol class="breadcrumb">
						<li><a href="index.html">Marché</a></li>
						<li class="active">Recherche Produits</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="col-md-7">
				...
				<form action="" method="GET">
					...
					<table>
						<tr>
							<td>
						<input type="text" name="search"class="search2" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" class="form-control" placeholder="Search data">
						</td>
						<td>
	...
	<div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-body">
                                ...
                                <?php 
                                    $con = mysqli_connect("localhost","root","","artisanica");

                                    if(isset($_GET['search'])){
                                    
                                        $filtervalues = $_GET['search'];
                                        $query = "SELECT * FROM produit WHERE CONCAT(nom_produit,prix_produit,nb_stock) LIKE '%$filtervalues%' ";
											...
											foreach($query_run as $items){
												...
												<table>
													<tr>
														<td>
												<div class="pro">
													<img src="images/shop/products/<?php echo $items["nom_image"];?>" alt="">
													<div class="des">
														<span>$<?php echo $items["nom_produit"];?></span>
														
														<div class="star">
															<!-- Your star rating display code here -->
														</div>
														<h4>$<?php echo $items["prix_produit"];?></h4>
													</div>
										...
										else
										{
											?>
												<tr>
													<td colspan="4">Pas de produits</td>
												</tr>
											<?php
										}	
									}
