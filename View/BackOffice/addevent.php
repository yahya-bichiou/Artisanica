...
// Le reste de votre code HTML et du formulaire
?>
...
<head>
   ...
   function validateForm() {
    ...
    var erreurLocalisation = document.getElementById("erreurLocalisation");

    // Réinitialiser les messages d'erreur
    erreurNom.innerHTML = "";
    erreurLocalisation.innerHTML = "";

    var isValid = true;

    // Valider le champ de type
    if (!/^[a-zA-Z]+$/.test(nom)) {
        erreurNom.innerHTML = "Le champ Nom de don doit contenir uniquement des lettres.";
    isValid = false;
}
if (!/^[a-zA-Z]+$/.test(localisation)) {
    erreurLocalisation.innerHTML = "Le champ Localisation de don doit contenir uniquement des lettres.";
    isValid = false;
}
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed"  data-toggle="collapse" data-target="#collapseevent"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Evenement</span>
                </a>
                <div id="collapseevent" class="collapse" aria-labelledby="headingTwo" >
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tablesEvent.php">All Events</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed"  data-toggle="collapse" data-target="#collapsedon"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Donation</span>
                </a>
                <div id="collapsedon" class="collapse" aria-labelledby="headingTwo" >
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Donation:</h6>
                        <a class="collapse-item" href="tablesdon.php">All Donations</a>
                    </div>
                </div>
            </li>
...
<div class="container">
    ...
    <form class="text-left clearfix" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" id="myForm">
            <div class="form-group">
                    ...
                    <input class="form-control"  placeholder="Nom d'Event" type="text" id="nom" name="nom" oninput="validateForm()" />
                    <span id="erreurNom" style="color: red"></span>
             
            </div>
            <div class="form-group">
              <input class="form-control" placeholder="Localisation" type="text" id="localisation" name="localisation" oninput="validateForm()" />
